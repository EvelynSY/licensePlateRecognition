...
imgName = 'LP14.jpg';   % The name of the picture
Ori = imread(fullfile(imgFolder,imgName));  % Read the image that need to be processed
c = Ori;
...
subplot(2,1,1);imshow(Ori);title('original image');
subplot(2,1,2);imshow(b);title(strcat('This license plate number is: ', char));
